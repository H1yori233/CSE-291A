...
SYSTEM_PROMPT_COORDINATE_MODE = (
    ...
    "2. DOUBLE_CLICK for desktop/file icons and tree nodes (to expand), LEFT_CLICK for buttons/menus\n"
    "3. Tree views in preferences/settings: DOUBLE_CLICK expands nodes, LEFT_CLICK only selects\n"
    "4. If element not found: use HOTKEY or coordinate click\n"
    "5. Never repeat failed actions - try different approach (e.g., DOUBLE_CLICK instead of LEFT_CLICK)\n"
    "6. Terminal: HOTKEY [\"ctrl\",\"alt\",\"t\"]. Chrome settings: type chrome://settings + Enter\n\n"
